@extends('base')
@section('content')
<div class="flex justify-center content-end" id="aboutBackgroundHeader"
    style="background-image: url({{asset('/images/poly.svg')}});">
...
<div class="flex justify-center">
    ...
    <section class="ml-10 mr-10 -mb-10">
        ...
        <h3 class="text-6xl mb-3">Crisis Mode?</h3>
        <p class="p-2">Please use the resources below:</p>
        <ul class="p-2 inspireList ">
            <li><span class="font-bold">Suicide Prevention Lifeline</span> 1-800-273-8255 <a
                    href="https://suicidepreventionlifeline.org/talk-to-someone-now/"
                    target="_blank">suicidepreventionlifeline.org <i class="fas fa-external-link-alt"></i> </a></li>
            <li><span class="font-bold">The Trevor Project</span> 1-866-488-7386 <a
                    href="https://www.thetrevorproject.org" target="_blank">thetrevorproject.org <i
                        class="fas fa-external-link-alt"></i> </a></li>
            <li><span class="font-bold">Now Matters Now </span><a href="https://www.nowmattersnow.org/help-line"
                    target="_blank">nowmattersnow.org/help-line <i class="fas fa-external-link-alt"></i></a></li>
            <li><span class="font-bold">IMAlive</span> <a href="https://www.imalive.org" target="_blank">
                    www.imalive.org <i class="fas fa-external-link-alt"></i></a></li>
        </ul>
    </section>
